...
app.get('/trails', async(req, res) => {
  try {
    const URL = `https://www.hikingproject.com/data/get-trails?latitude=${req.query.latitude}&longitude=${req.query.longitude}&maxDistance=200&key=${process.env.HIKING_KEY}`;
